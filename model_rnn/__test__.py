...
file_list = list(os.listdir('../train_log/RNN'))
...
for file in file_list:
    ...
    if ('.pkl' in file) and ('rnn' in file):
...
rnn_dir = '../train_log/RNN/' + state_list[target]

rnn = torch.load(rnn_dir)
...
os.makedirs('../test_log/RNN', exist_ok=True)
log_dir = '../test_log/RNN/log_' + state_list[target].strip('.pkl').strip('rnn_') + '.xlsx'
predictions_dir = '../test_log/RNN/predictions_' + state_list[target].strip('.pkl').strip('rnn_') + '.xlsx'
